...
function gwCollection(){
   ...
   function Questions(){
    ...
    var yes=createSprite(300,400,50,50);
    yes.addImage(yesImg);
    yes.scale =0.2;
    var no=createSprite(1000,400,50,50);
    no.addImage(noImg);
    no.scale = 0.2;
    ...
    switch(gameState){
      case "level1":    
                         textSize(25);
                        text(' Do you think that inequalities like gender and cultural identity should affect education’s reach?', 100,250);
